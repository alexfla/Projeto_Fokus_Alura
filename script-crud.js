...
function criarElementoTarefa(tarefa) {
    ...
    if (tarefa.completa){
       ...
       botao.setAttribute('disabled', 'disebled');
    } else {
        li.onclick = () => {
            ...
            li.classList.add('app__section-task-list-item-active.app'); //tirei o ponto
        };
    }
...
document.addEventListener('Focofinalizado', () =>{
    if (tarefaSelecionada && liTarefaSelecionada){
        ...
        liTarefaSelecionada.querySelector('button').setAttribute('disabled', 'disebled');
